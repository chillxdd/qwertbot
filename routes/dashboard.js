...
const { MAX_PERSISTENT_PIN_MESSAGE_LENGTH, MAX_PERSISTENT_PIN_MESSAGES, DEFAULT_PERSISTENT_PIN_ROTATION_SECONDS, MIN_PERSISTENT_PIN_ROTATION_SECONDS, MAX_PERSISTENT_PIN_ROTATION_SECONDS, DEFAULT_PERSISTENT_PIN_HOLD_SECONDS, MAX_PERSISTENT_PIN_HOLD_SECONDS } = require('../services/persistentStreamPin');
const {
  ...
  app.get('/webui-config', (req, res) => {
    res.json({
      ...
      timers: {
        ...
        maxPersistentPinMessageLength: MAX_PERSISTENT_PIN_MESSAGE_LENGTH,
        maxPersistentPinMessages: MAX_PERSISTENT_PIN_MESSAGES,
        defaultPersistentPinRotationSeconds: DEFAULT_PERSISTENT_PIN_ROTATION_SECONDS,
        minPersistentPinRotationSeconds: MIN_PERSISTENT_PIN_ROTATION_SECONDS,
        maxPersistentPinRotationSeconds: MAX_PERSISTENT_PIN_ROTATION_SECONDS,
        defaultPersistentPinHoldSeconds: DEFAULT_PERSISTENT_PIN_HOLD_SECONDS,
        maxPersistentPinHoldSeconds: MAX_PERSISTENT_PIN_HOLD_SECONDS
      },
      customCommands: {
